...
#ifndef HGPLACEHOLDERS_SWIFT_H
#define HGPLACEHOLDERS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HGPlaceholders",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14HGPlaceholders14CollectionView")
...
/// \param frame A rectangle specifying the initial location and size of the collection view in its superview’s coordinates. The frame of the collection view changes as collection cells are added and deleted.
///
/// \param style A constant that specifies the style of the collection view. See collection view Style for descriptions of valid constants.
///
///
/// returns:
/// Returns an initialized collectionView object, or nil if the object could not be successfully initialized.
...
SWIFT_CLASS("_TtC14HGPlaceholders29PlaceholderCollectionViewCell")
...
SWIFT_CLASS("_TtC14HGPlaceholders24PlaceholderTableViewCell")
...
SWIFT_CLASS("_TtC14HGPlaceholders9TableView")
...
/// \param frame A rectangle specifying the initial location and size of the table view in its superview’s coordinates. The frame of the table view changes as table cells are added and deleted.
///
/// \param style A constant that specifies the style of the table view. See Table View Style for descriptions of valid constants.
///
///
/// returns:
/// Returns an initialized TableView object, or nil if the object could not be successfully initialized.
